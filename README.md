...
```
docker build -t helidon-jlink -f Dockerfile.jlink .
```

Start the application:

```
docker run --rm -p 8080:8080 helidon-jlink:latest
```

See the start script help:

```
docker run --rm helidon-jlink:latest --help
```
